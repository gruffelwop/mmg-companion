...
class HomeViewExp extends StatefulWidget {
  const HomeViewExp({super.key});

  @override
  State<HomeViewExp> createState() => _HomeViewExpState();
}

class _HomeViewExpState extends State<HomeViewExp> {
    ...
    return CustomPageScaffold(
      child: Column(
        children: [
          ...
          const CustomMargin(amount: 40 - 16),
          const Align(
