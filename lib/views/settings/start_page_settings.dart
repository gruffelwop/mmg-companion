...
class StartPageSettings extends StatefulWidget {
  const StartPageSettings({super.key});

  @override
  State<StartPageSettings> createState() => _StartPageSettingsState();
}

class _StartPageSettingsState extends State<StartPageSettings> {
  String? startPage;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        // Section Header
        const CustomSectionHeader(name: "start page"),
